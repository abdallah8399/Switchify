...
public class ChatActivity extends AppCompatActivity {
    ...
    private Button dealDone;
    private DatabaseReference contactsRef, imageReference, desRef;
    private ImageView productImagePinned;
    private TextView productDescriptionPinned;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageReference= FirebaseDatabase.getInstance().getReference("Product Images").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
        ...
        desRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                productDescriptionPinned.setText(dataSnapshot.getValue().toString());
            }
        ...
        imageReference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Picasso.get().load(dataSnapshot.getValue().toString()).into(productImagePinned);
            }
        ...
        dealDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                contactsRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(messageReceiverID).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(ChatActivity.this, "Deal Done", Toast.LENGTH_SHORT).show();
    ...
    private void initializeControllers() {
        ...
        dealDone= findViewById(R.id.btnDealDone);
        SendMessageButton = findViewById(R.id.send_message_btn);
        MessageInputText = findViewById(R.id.input_message);
        productDescriptionPinned = findViewById(R.id.textView4);
        productImagePinned= findViewById(R.id.productChatImage);
